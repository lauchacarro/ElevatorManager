...
{
    public class ElevatorTripServiceTests_MoveElevatorFromOutsideAsync_Tests
    {
        [Fact]
        public async Task Should_ReturnSuccessWithPriorityLow_When_Valid()
        {
            // Arrange
            ...
            // Assert
            Assert.Equal(Priority.Low, result.Value.Priority);
        }
